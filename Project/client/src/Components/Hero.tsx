...
export const Hero = ({ onButtonClick }: HeroProps) => {
  return (
    <div className="hero-container lg:flex-row sm:flex sm:flex-col lg:justify-between sm:justify-center items-center sm:gap-10 border-b-2 border-gray-800 h-[800px]">
